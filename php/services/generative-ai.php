	...
	<div class="container">
		<div class="cta-content">
			...
			<div class="cta-button-group">
				<a href="/contact.php" class="cta-button cta-button-primary">Schedule a Gen AI Consultation</a>
				<a href="/contact.php" class="cta-button cta-button-secondary">Explore Use Cases</a>
			</div>
		</div>
	</div>
</section>
