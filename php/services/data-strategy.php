	...
	<div class="container">
		<div class="cta-content">
			...
			<div class="cta-button-group">
				<a href="/contact.php" class="cta-button cta-button-primary">Schedule Strategy Workshop</a>
				<a href="/contact.php" class="cta-button cta-button-secondary">Get Started Today</a>
			</div>
		</div>
	</div>
</section>
