                ...
                <div class="tier-card default-background rounded-lg overflow-hidden shadow-sm h-100">
                    ...
                    <div class="tier-body p-4">
                        <ul class="tier-features mb-0 ">
                            ...
                            <li class=" mb-3 text-light"><i class="fas fa-check me-2" s></i> Regular product updates</li>
    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-4 text-lg-end text-center mt-3 mt-lg-0">
                <a href="contact.php" class="btn btn-light btn-lg rounded-pill px-5 fw-bold text-light" style="color: #667eea;">
