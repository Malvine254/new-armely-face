...
<style>
  ...
  .values-section .single-service i.icofont {
  ...
  <div class="container">
    ...
    <div class="row justify-content-center align-items-center">
      <div class="col-md-2 col-6 mb-4 text-center">
        <img width="180" height="180" class="img-fluid" src="images/affiliation/mbe.svg">
      </div>
      <div class="col-md-2 col-6 mb-4 text-center">
        <img width="180" height="180" class="img-fluid" src="images/affiliation/smb.svg">
      </div>
      <div class="col-md-2 col-6 mb-4 text-center">
        <img width="160" height="160" class="img-fluid" src="images/affiliation/affliation1.png">
      </div>
      <div class="col-md-2 col-6 mb-4 text-center">
        <img width="160" height="160" class="img-fluid" src="images/affiliation/fid.png">
      </div>
      <div class="col-md-3 col-12 mb-4 text-center">
        <img width="200" class="img-fluid" src="images/affiliation/partner.png">
      </div>
    </div>
  </div>
</section>
        ...
        <div class="row g-4">
            ...
            <div class="modern-card h-100">
              <div class="d-flex align-items-start mb-4">
                <div class="entity-logo-wrapper me-3">
                  <img src="images/logo/mela-logo.jpg" alt="Mela Logo" />
                </div>
                <div>
          ...
          <div class="col-md-6">
            <div class="modern-card h-100">
              <div class="d-flex align-items-start mb-4">
                <div class="entity-logo-wrapper me-3">
                  <img src="images/logo/logo-step.png" alt="Step & Sip Logo" />
                </div>
                <div>
